  ...
  return (
    <div className="w-full max-w-2xl mx-auto space-y-4 sm:space-y-6">
        ...
        {THEMES.map((theme) => {
          ...
          return (
            <button
              ...
              `}
            >
              <Icon className={`w-4 h-4 sm:w-5 sm:h-5 ${isActive ? 'text-brand-600' : 'text-zinc-500'}`} />
        ...
        {selected === 'CLASSIC' && (
          <div className="w-full max-w-sm sm:max-w-md bg-white dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 rounded-xl p-4 sm:p-5 shadow-sm font-sans animate-fade-in">
            <div className="flex justify-between items-center mb-4">
              <span className="text-[10px] sm:text-xs font-bold tracking-wider text-brand-600 uppercase">Day 1</span>
            ...
            <div className="flex gap-3 text-xs sm:text-sm text-zinc-600 dark:text-zinc-400 border-l-2 border-brand-500 pl-3">
      ...
      <div className="h-6 flex items-center justify-center">
        ...
        {saved && !isPending && (
          <span className="text-xs sm:text-sm text-brand-600 flex items-center gap-1">
